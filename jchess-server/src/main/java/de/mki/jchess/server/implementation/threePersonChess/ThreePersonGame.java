...
public class ThreePersonGame extends Game {
    ...
    public void initializeGame() {
        ...
        try {
            getChessboard().getFigures().add((Figure<Hexagon>) new Rook(playerWhite).setPosition(chessboard.getFieldByNotation(0, 0)).setPictureId("rook-white"));
            getChessboard().getFigures().add((Figure<Hexagon>) new Knight(playerWhite).setPosition(chessboard.getFieldByNotation(1, 0)).setPictureId("knight-white"));
            getChessboard().getFigures().add((Figure<Hexagon>) new Bishop(playerWhite).setPosition(chessboard.getFieldByNotation(2, 0)).setPictureId("bishop-white"));
            getChessboard().getFigures().add((Figure<Hexagon>) new Queen(playerWhite).setPosition(chessboard.getFieldByNotation(3, 0)).setPictureId("queen-white"));
            getChessboard().getFigures().add((Figure<Hexagon>) new King(playerWhite).setPosition(chessboard.getFieldByNotation(4, 0)).setPictureId("king-white"));
            getChessboard().getFigures().add((Figure<Hexagon>) new Knight(playerWhite).setPosition(chessboard.getFieldByNotation(5, 0)).setPictureId("knight-white"));
            getChessboard().getFigures().add((Figure<Hexagon>) new Bishop(playerWhite).setPosition(chessboard.getFieldByNotation(6, 0)).setPictureId("bishop-white"));
        ...
        try {
            getChessboard().getFigures().add((Figure<Hexagon>) new Rook(playerGrey).setPosition(chessboard.getFieldByNotation(12, 5)).setPictureId("rook-grey"));
            getChessboard().getFigures().add((Figure<Hexagon>) new Knight(playerGrey).setPosition(chessboard.getFieldByNotation(12, 6)).setPictureId("knight-grey"));
            getChessboard().getFigures().add((Figure<Hexagon>) new Bishop(playerGrey).setPosition(chessboard.getFieldByNotation(12, 7)).setPictureId("bishop-grey"));
            getChessboard().getFigures().add((Figure<Hexagon>) new Queen(playerGrey).setPosition(chessboard.getFieldByNotation(12, 8)).setPictureId("queen-grey"));
            getChessboard().getFigures().add((Figure<Hexagon>) new King(playerGrey).setPosition(chessboard.getFieldByNotation(12, 9)).setPictureId("king-grey"));
            getChessboard().getFigures().add((Figure<Hexagon>) new Knight(playerGrey).setPosition(chessboard.getFieldByNotation(12, 10)).setPictureId("knight-grey"));
            getChessboard().getFigures().add((Figure<Hexagon>) new Bishop(playerGrey).setPosition(chessboard.getFieldByNotation(12, 11)).setPictureId("bishop-grey"));
        ...
        try {
            getChessboard().getFigures().add((Figure<Hexagon>) new Rook(playerBlack).setPosition(chessboard.getFieldByNotation(7, 12)).setPictureId("rook-black"));
            getChessboard().getFigures().add((Figure<Hexagon>) new Knight(playerBlack).setPosition(chessboard.getFieldByNotation(6, 11)).setPictureId("knight-black"));
            getChessboard().getFigures().add((Figure<Hexagon>) new Bishop(playerBlack).setPosition(chessboard.getFieldByNotation(5, 10)).setPictureId("bishop-black"));
            getChessboard().getFigures().add((Figure<Hexagon>) new Queen(playerBlack).setPosition(chessboard.getFieldByNotation(4, 9)).setPictureId("queen-black"));
            getChessboard().getFigures().add((Figure<Hexagon>) new King(playerBlack).setPosition(chessboard.getFieldByNotation(3, 8)).setPictureId("king-black"));
            getChessboard().getFigures().add((Figure<Hexagon>) new Knight(playerBlack).setPosition(chessboard.getFieldByNotation(2, 7)).setPictureId("knight-black"));
            getChessboard().getFigures().add((Figure<Hexagon>) new Bishop(playerBlack).setPosition(chessboard.getFieldByNotation(1, 6)).setPictureId("bishop-black"));
