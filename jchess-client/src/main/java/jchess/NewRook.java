...
public class NewRook extends Piece {
    ...
    public ArrayList allMoves() {
        ...
        for (int i = this.square.pozY + 1; i <= Math.min(this.square.pozY + 5, 7); ++i) {//up
        ...
        for (int i = this.square.pozY - 1; i >= Math.max(this.square.pozY - 5, 0); --i) {//down
        ...
        for (int i = this.square.pozX - 1; i >= Math.max(this.square.pozX - 5, 0); --i) {//left
        ...
        for (int i = this.square.pozX + 1; i <= Math.min(this.square.pozX + 5, 7); ++i) {//right
